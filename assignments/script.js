...
function handlePassword() {
  ...
  if (userPassword === "saheema") {
    result.innerHTML =
      "<span style='color:green;font-weight:bold;'>Login Successful<br><br>" +
    ...
    if (attempts >= 3) {
      ...
      result.innerHTML =
        "<span style='color:red;font-weight:bold;'>Wrong Username<br>" +
        "Remaining Attempts : " + (3 - attempts) + "</span>";
    }
  }
}
